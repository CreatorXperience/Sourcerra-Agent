...
class InterviewQuestionWorkflow(BaseWorkflow):
    async def execute(
        self,
        candidate_id: str,
        job_id: str,
        ...
        **kwargs: Any,
        ...
        agent = registry.get("interview-question-generator")
        if not agent:
            return AgentRunResponse(
                run_id="",
                agent_name="interview-question",
                status=AgentStatus.ERROR,
                error="Interview question generator agent not registered",
            )
