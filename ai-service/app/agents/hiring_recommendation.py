...
class HiringRecommendationAgent(BaseAgent):
    async def run(
        ...
        prompt_path = Path(__file__).parent.parent / "prompts" / "hiring_recommendation.md"
        ...
        openai_agent = OpenAIAgent(
            ...
            output_type=HiringRecommendationOutput,
        )
        ...
        output: HiringRecommendationOutput = result.final_output
