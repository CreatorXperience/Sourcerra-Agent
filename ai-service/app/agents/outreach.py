...
class OutreachGenerationAgent(BaseAgent):
    async def run(
        ...
        prompt_path = Path(__file__).parent.parent / "prompts" / "outreach.md"
        ...
        openai_agent = OpenAIAgent(
            name="OutreachGenerationAgent",
            instructions=instructions,
            output_type=OutreachGenerationOutput,
        )
        ...
        output: OutreachGenerationOutput = result.final_output
