...
class InterviewDebriefAgent(BaseAgent):
    async def run(
        self,
        task: str,
        ...
        prompt_path = Path(__file__).parent.parent / "prompts" / "interview_debrief.md"
        ...
        openai_agent = OpenAIAgent(
            name="InterviewDebriefAgent",
            instructions=instructions,
            output_type=InterviewDebriefOutput,
        )
        ...
        output: InterviewDebriefOutput = result.final_output
