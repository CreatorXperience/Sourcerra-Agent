...
from app.schemas.workflows import RecruiterCopilotSynthesis
...
class RecruiterCopilotAgent(BaseAgent):
    async def run(
        ...
        prompt_path = Path(__file__).parent.parent / "prompts" / "recruiter_copilot.md"
        ...
        openai_agent = OpenAIAgent(
            ...
            output_type=RecruiterCopilotSynthesis,
        )
        ...
        output: RecruiterCopilotSynthesis = result.final_output
