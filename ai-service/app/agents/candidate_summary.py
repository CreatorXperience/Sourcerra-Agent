...
class CandidateSummaryAgent(BaseAgent):
    async def run(
        self,
        task: str,
        ...
        prompt_path = Path(__file__).parent.parent / "prompts" / "candidate_summary.md"
        ...
        openai_agent = OpenAIAgent(
            name="CandidateSummaryAgent",
            instructions=instructions,
            output_type=CandidateSummaryOutput,
        )
        ...
        output: CandidateSummaryOutput = result.final_output
